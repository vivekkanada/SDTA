...
if(isset($_POST['submit']))
{
    ...
    $q="insert into addbill values(0,$cid,$iid,'$qty','$price','$total','$date','$paid','$balance');";
...
//         echo "<script>alert('balance updated')</script>";   
         $q3="select total_bag from additem where iid='$iid'";
         $res3= mysqli_query($db, $q3);
   $row3= mysqli_fetch_assoc($res3);
    $dec=$row3['total_bag'];
         $dec=$dec-$qty;
          $q4="update additem set total_bag='$dec' where iid='$iid' ";
...
@media screen and (max-width: 300px) {
  ...
  <div class="form-group form-check">
      ...
      <select  class="form-control" onchange="cal()" name="browser1" id="browser1">
  ...
  <div class="form-group form-check">
      <input type="number" class="form-control" placeholder="TOTAL" name="total" value="" id="total">
       <input type="button" id="calculate" onclick="fun()" value="calculate">
      <script>
            function fun()
            {
  ...
  <div class="form-group form-check">
      <input type="number" class="form-control" placeholder="ENTER AMOUNT" name="paid" id="paid">
  ...
  <div class="form-group form-check">
      <input type="number" class="form-control" placeholder="BALANCE" name="balance" id="balance">
       ...
       <input type="button" id="calculate1" onclick="funct()" value="calculate">
      <script>
            function funct()
            {
