...
if(isset($_POST['submit']))
{
    ...
    $q="insert into payment values(0,'$id','$paid','$bal','$date');";
  
    if(mysqli_query($db, $q))
  {
 
        $q5="update addcustomer set balance='$bal' where cid='$id'";
...
@media screen and (max-width: 300px) {
  ...
  document.getElementById("bal").value = res[1];
 }</script>
 <title>PAYMENTS</title>
  ...
  <div class="form-group">
    ...
    <select  class="form-control"  onchange="myfun()" name="browser" id="browser" required >
    ...
    {
        ?>
          <option   value="<?php echo $row['cid'].':'. $row['balance']?>"><?php echo $row['name']   ?></option>
      <?php
    }?>
  ...
  <div class="form-group form-check">
      <input type="text" class="form-control" placeholder="BALANCE" value="" name="bal" id="bal" required  title="ENTER DIGITS ONLY" >
  ...
  <div class="form-group form-check">
      <input type="number" class="form-control" onchange="cal()" placeholder="ENTER AMOUNT" name="price" id="price" required title="ENTER DIGITS ONLY" >
  ...
  <div class="form-group form-check">
      <input type="number" class="form-control" placeholder="TOTAL" name="total" value="" id="total" required  >
