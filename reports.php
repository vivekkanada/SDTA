            ...
            <DIV class="container-fluid">
                ...
                <form action="reports.php" method="post"> 
                    ...
                    <div class="" align="center">
                        ...
                        <label>SELECT STARING DATE</label>
    ...
    if(isset($_POST['submit']))
{
        ...
        echo $sdate, $edate;
    $query="select b.name,c.iname,a.bid,a.qty,a.price,a.date,a.total,a.paid,a.balance from addbill a,addcustomer b,additem c where date between '$sdate' and '$edate' and a.cid=b.cid and a.iid=c.iid ";
